        ...
        <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
          <div className="relative space-y-6">
            ...
            <div className="space-y-5">
              <h1 className="max-w-[10ch] font-display text-5xl leading-[0.9] md:text-7xl">
                Five cities. One view. Always fresh.
              </h1>
              <p className="max-w-2xl text-base leading-7 text-ink/70 md:text-lg">
                Pick the cities you want. See how they compare right now — temperature, comfort, conditions, and when the sun goes down — and watch it update on its own.
              </p>
            </div>
          ...
          <div className="grid gap-4 md:grid-cols-3 lg:grid-cols-1">
            <div className="rounded-[24px] border border-storm/30 bg-storm/20 p-5">
              <div className="text-xs uppercase tracking-[0.24em] text-storm/80">Refresh rate</div>
              <div className="mt-3 font-display text-4xl text-storm">5m</div>
              <p className="mt-2 text-sm leading-6 text-ink/70">Weather readings pull in automatically every five minutes.</p>
            </div>
            ...
            <div className="rounded-[24px] border border-signal/20 bg-signal/10 p-5">
              <div className="text-xs uppercase tracking-[0.24em] text-signal/80">How it works</div>
              <p className="mt-3 text-sm leading-7 text-ink/75">Readings come in, rankings update, and your personal view refreshes — all without reloading.</p>
            </div>
          </div>
        </div>
      </section>
