...
export function DashboardTopline({ latestSnapshots, history }: Props) {
  ...
  return (
    <div className="glass-panel terminal-panel motion-card overflow-hidden bg-[#091e3a] px-6 py-6 text-ink">
      <div className="grid gap-6">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="terminal-pulse motion-tile rounded-[28px] border border-storm/20 bg-storm/10 px-5 py-4 lg:min-w-[220px]">
        ...
        <div className="grid gap-3 md:grid-cols-3">
          <div className="motion-tile rounded-[24px] border border-storm/20 bg-panel/60 p-4">
  ...
  return (
    <div className="glass-panel terminal-panel motion-card px-6 py-6">
      ...
      <div className="mt-6 grid gap-3 md:grid-cols-4">
        <div className="motion-tile rounded-[24px] border border-storm/15 bg-panel p-4">
      ...
      <div className="mt-6 grid gap-3">
        {summary.rows.map((row) => (
          <div key={row.city_id} className="motion-tile rounded-[24px] border border-storm/15 bg-panel px-4 py-4">
            <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
              ...
              <div className="grid flex-1 gap-3 sm:grid-cols-2 xl:grid-cols-5">
                <div className="motion-tile rounded-[18px] border border-storm/15 bg-cloud/80 px-3 py-3">
